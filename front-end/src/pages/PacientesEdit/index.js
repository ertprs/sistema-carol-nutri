    ...
    async function handleSubmit(data){
        ...
        if(!informacoesMedicas){
            ...
            await api.put(`form/edit/${informacoesMedicas._id}`, {
                ...
                physicalExam: {
                    drySkin: data.drySkin,
                    mucousMoisture: data.mucousMoisture,
                    lossOfHair: data.lossOfHair,
                    edema: data.edema,
                    weakness: data.weakness,
                    conjunctivalPallor: data.conjunctivalPallor,
                    koilonychicNails: data.koilonychicNails,
                    obsPhysicalExam: data.obsPhysicalExam
                }
            }).then((response) => {
                setInformacoesMedicas(response.data)
    ...
    if(!informacoesMedicas){
            ...
            <Container>
                ...
                <MedicalInfo>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <button type="submit" onSubmit={e => { e.preventDefault()}}>Cadastrar dados</button>
                    </Form>
                </MedicalInfo>
            </Container>
            )
        ...
        return (
            <Container>
                ...
                <MedicalInfo>
                    <Form onSubmit={handleSubmit} initialData={informacoesMedicas}>
                        <h4>1. INFORMAÇÕES PESSOAIS</h4>
                        <Scope path="PersonalInformation">
                            <div>
                                ...
                                <div>
                                    {
                                        <Select defaultChecked={informacoesMedicas.PersonalInformation?.maritalStatus} defaultValue={informacoesMedicas.PersonalInformation?.maritalStatus} label="Estado civil" name="maritalStatus" id="maritalStatus" options={[{id: "solteiro", title: 'Solteiro'}, {id: "casado", title: 'Casado'}, {id: "divorciado", title: 'Divorciado'}]} placeholder="Selecione uma opção"/>  
